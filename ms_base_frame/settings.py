"""
Django settings for ms_base_frame project.
...
SECRET_KEY = 'django-insecure-l&00w#zkysvd7_ols6uwh8$==+h4y7@%(3r8%2$7lk0a7^i1eb'
...
WSGI_APPLICATION = 'ms_base_frame.wsgi.application'
